...
public class ComonOrderListAdapter extends BaseLGAdapter {

    public OnExpandItemClidkListener expandItemClidkListener;
    public int status; //0为常用清单 1是搜索

    public ComonOrderListAdapter(Context context, ArrayList datas, OnExpandItemClidkListener listener) {
        super(context, datas);
