...
//import com.lr.baseview.widget.FullyLinearLayoutManager;
...
public class CommonOrderListFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, OnExpandItemClidkListener {
    ...
    public static CommonOrderListFragment Instanst(String type, ArrayList ProductionInfoList) {
        CommonOrderListFragment mInstance = new CommonOrderListFragment();
...
//        swipeToLoadLayout.setRefreshEnabled(type != 1);
        swipeToLoadLayout.setLoadMoreEnabled(false);
        swipeToLoadLayout.setOnRefreshListener(this);
        swipeToLoadLayout.setOnLoadMoreListener(this);

        tv_none_hint.setVisibility(View.GONE);
//        swipeTarget.setLayoutManager(new FullyLinearLayoutManager(context));
