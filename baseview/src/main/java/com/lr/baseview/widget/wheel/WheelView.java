...
package com.lr.baseview.widget.wheel;
...
import com.lr.baseview.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int getDesiredHeight(LinearLayout layout) {
		...
		int desired = itemHeight * visibleItems - itemHeight * ITEM_OFFSET_PERCENT / 100;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.province_line_border)); // 中间项（选中项）上下的线条颜色
