...
//        progressBar.startAnimation(rotateAnimation);
    ...
    public void onMove(int y, boolean isComplete, boolean automatic) {
        if (!isComplete) {
            ...
            ivSuccess.setVisibility(GONE);
            if (y > mHeaderHeight) {
                tvRefresh.setText(getResources().getString(R.string.release_refreshing));
                if (!rotated) {
                    ivArrow.clearAnimation();
                ...
                tvRefresh.setText(getResources().getString(R.string.pull_down_refreshing));
            }
        }
    }
    ...
    public void onComplete() {
        ...
        tvRefresh.setText(getResources().getString(R.string.completed));
    }
